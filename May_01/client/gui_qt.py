"""PySide6 reimplementation of the client exam timer + submission GUI.

Mirrors the behaviour of ``client/gui_tk.py`` but uses Qt widgets.
Selected at runtime by ``client/gui.py --ui qt``.
"""
...
class SubmissionWindow(QMainWindow):
    ...
    def _build_layout(self) -> None:
        ...
        self.upload_button = QPushButton("Upload And Finish")
...
class ExamTimerGUI(QMainWindow):
    ...
    def _build_widgets(self) -> None:
        ...
        timer_font.setPointSize(max(timer_font.pointSize() + 6, 16))
        self.timer_label = QLabel("Waiting")
        self.timer_label.setFont(timer_font)
        self.timer_label.setAlignment(Qt.AlignCenter)
        self.timer_label.setFrameShape(QFrame.StyledPanel)
        ...
        self.start_button = QPushButton("Request Start")
        ...
        self.footer_label.setFrameShape(QFrame.StyledPanel)
