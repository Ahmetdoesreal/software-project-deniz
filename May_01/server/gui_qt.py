...
class _OptionsDialog(QDialog):
    def __init__(
        ...
        kick_btn = QPushButton("Kick Client")
        ...
        savescreen_btn = QPushButton("Request Save Screen")
        ...
        process_btn = QPushButton("Request Process Report")
...
class ServerGUI(QMainWindow):
    ...
    def _build_server_info_panel(self, parent_layout: QVBoxLayout) -> None:
        ...
        self.finish_exam_button = QPushButton("Finish Exam")
        ...
        grid = QGridLayout()
        self.edit_blacklist_button = QPushButton("Edit Blacklist")
        self.edit_blacklist_button.clicked.connect(self.edit_blacklist)
        grid.addWidget(self.edit_blacklist_button, 0, 0)
        self.apply_blacklist_button = QPushButton("Apply Blacklist")
        ...
        self.server_info_detail_button = QPushButton("Detailed Info")
    ...
    def _rebuild_client_table(self) -> None:
        ...
        for row, (client_id, data) in enumerate(ordered):
            ...
            self.client_table.setItem(row, 1, QTableWidgetItem(str(data.get("status_label", "Unknown"))))
