"""PySide6 reimplementation of the Exam Client manager.

Behaviourally mirrors ``client_launcher_tk`` but uses Qt widgets. Selected via
...
class ClientManager(QMainWindow):
    ...
    def _build_layout(self) -> None:
        ...
        self.start_button = QPushButton("Connect && Login")
        ...
        self.cli_button = QPushButton("Open Session CLI")
        ...
        hint.setStyleSheet("color: #5c4d7d;")
    ...
    def _launch_client_process(self) -> None:
        self.validation_in_progress = False
        env = {
        ...
        self.status_label.setText("Client running under manager control.")
