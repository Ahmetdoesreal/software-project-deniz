"""PySide6 reimplementation of the Exam Server manager.

Mirrors ``server_launcher_tk`` but uses Qt widgets. Selected via
...
class ServerManager(QMainWindow):
    ...
    def _build_layout(self) -> None:
        ...
        self.gui_button = QPushButton("Open Dashboard")
    ...
    def _build_server_command(self) -> list[str]:
        command = [
            ...
            "--host",
            self.host_entry.text().strip() or "0.0.0.0",
            "--port",
    ...
    def _session_summary_text(self) -> str:
        ...
        return (
            ...
            f"host={self.host_entry.text().strip() or '0.0.0.0'}    "
