...
def create_app(args) -> web.Application:
    ...
    # Register authentication & security module
    # Admin endpoints: /admin/status, /admin/list, /admin/force_stop,
    # /admin/pause, /admin/resume, /admin/extra_time, /admin/unban
    from . import baris_features
    baris_features.register_admin_routes(app)
    baris_features.print_startup_banner()
