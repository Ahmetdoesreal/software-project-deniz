...
def _safe_close_message(reason: str, max_bytes: int = 120) -> bytes:
    # WebSocket close frame allows ~123 bytes of reason payload (RFC 6455).
        ...
        clients.append(
            {
                ...
                "last_focus_event_at": user.get("last_focus_event_at", ""),
                "last_focus_event_type": user.get("last_focus_event_type", ""),
                "last_focus_severity": user.get("last_focus_severity", ""),
                "last_focus_process": user.get("last_focus_process", ""),
