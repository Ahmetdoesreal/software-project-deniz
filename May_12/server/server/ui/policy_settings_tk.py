...
class PolicySettingsMixin:
    ...
    def _build_process_lists_settings_section(self):
        ...
        self._settings_text(unexpected, "Allowed process names or wildcards, one per line", "rules.unexpected_process.allowed_process_names", 3, height=3)
    ...
    def _build_window_rules_settings_section(self):
        ...
        self._settings_text(focused, "Allowed process names or wildcards, one per line", "rules.focused_window.allowed_process_names", 2, height=2)
        self._settings_text(focused, "Allowed titlebar text, one per line", "rules.focused_window.allowed_window_titles", 3, height=2)
        self._settings_text(focused, "Blocked process names or wildcards, one per line", "rules.focused_window.blocked_process_names", 4, height=2)
