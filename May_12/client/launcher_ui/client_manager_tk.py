...
class ClientManager(tk.Tk):
    ...
    def _run_login_check(self):
        ...
        if auth_status_requires_admin_validation(auth_status):
            self.after(0, self._launch_client_process, auth_notice)
            return
    ...
    def _launch_client_process(self, auth_notice: str = ""):
        self.validation_in_progress = False
        ...
        self.status_var.set(self._auth_status_notice or "Client running under manager control.")
