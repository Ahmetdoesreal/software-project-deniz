...
from common.process_definitions import process_name_matches_any
...
class ProcessMonitor:
    def __init__(
        ...
        *,
        ...
        self.reported_matches: set[tuple[int, str, str | None, str | None]] = set()
    ...
    def _detect_blacklist_matches(self, processes: set[ProcessEntry]) -> list[dict]:
        ...
        for process in processes:
            ...
            if not process_name_matches_any(normalized_name, self.blacklist_names):
                continue
            ...
            if normalized_username and normalized_username not in self.blacklist_usernames:
                continue
            current_matches.add((pid, name, username, process_path))
        ...
        return [
            ...
            for pid, name, username, process_path in sorted(new_matches, key=lambda item: (item[1].lower(), item[0]))
        ]
