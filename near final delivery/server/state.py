        ...
        payload = {
            ...
            "rules": [
                ...
                },
                {
                    ...
                    "max_switches": int(rapid_switching.get("max_switches", 4)),
                    "window_observations": int(rapid_switching.get("window_observations", 4)),
    ...
    def _normalize_exam_policy_config(self, config: dict) -> dict:
        ...
        if isinstance(rapid_switching, dict):
            ...
            normalized["rules"]["rapid_application_switching"]["max_switches"] = max(
                1,
                int(rapid_switching.get("max_switches", 4) or 4),
            )
            normalized["rules"]["rapid_application_switching"]["window_observations"] = max(
                1,
                int(rapid_switching.get("window_observations", 4) or 4),
            )
